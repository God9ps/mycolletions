...
<div class="row">
            ...
            <div class="dash-unit">
                ...
                <hr>
                        ...
                        <form id="loginForm" name="loginForm" method="post">
                            <fieldset>
                                <p>
                                    <input class="inputLogin" id="email" name="email" type="email" placeholder="Username">
                                    <input class="inputLogin" id="password" name="password" type="password" placeholder="Password">
                                </p>
                                <p>
                                    <button id="submitLogin" class="btn-success btn btn-large pull-right" style="margin-left: 5px;">Entrar</button>
                                    <button class="btn-info btn btn-large pull-right" style="margin-left: 5px;">Registar</button>
                                </p>
                            </fieldset>
                        </form>
    ...
    if ($_SESSION['login'] == true) {
        ...
        include_once "caixa_true.php";
    }else{
        include_once "caixa_false.php";
    }
    ?>
                ...
                <div class="window">
                    <ul class="mail">
                        <li>
                            ...
                            <div class="actions">
                                <a><img src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/undo.png"
                                        alt="reply"></a>
                                <a><img src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/star_fav.png"
                                        alt="favourite"></a>
                                <a><img src="http://png-4.findicons.com/files//icons/2232/wireframe_mono/16/tag.png"
                                        alt="label"></a>
                                <a><img src="http://png-4.findicons.com/files//icons/2232/wireframe_mono/16/trash.png"
                                        alt="delete"></a>
                            </div>
                        </li>
                        <li>
...
<div class="row">
    ...
    <div class="col-sm-3 col-lg-3">
        ...
        <div class="half-unit">
            ...
            <div class="cont">
                ...
                <p><img src="assets/img/up-small.png" alt=""> 412 Max. | <img src="assets/img/down-small.png"
                                                                              alt=""> 89 Min.</p>
            </div>
        </div>
    ...
    <div class="col-sm-3 col-lg-3">
        <div class="dash-unit">
            ...
            <br>
            <div class="text">
                <p><b>Alvarez.is:</b> A beautiful new Dashboard theme has been realised by Carlos Alvarez. Please,
                    visit <a href="http://alvarez.is">Alvarez.is</a> for more details.</p>
                <p>
...
<!--            <!-- Script Needed to load the Tweets -->
<!--            <script-->
<!--                src="http://api.twitter.com/1/statuses/user_timeline/wrapbootstrap.json?callback=twitterCallback2&amp;count=1"></script>-->
<!--            <!-- To show your tweets replace "wrapbootstrap", in the line above, with your user. -->
<!--            <div class="text">-->
<!--                <p>-->
<!--                    <grey>Show your tweets here!</grey>-->
<!--                </p>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <div class="cont">-->
<!--                <p>-->
<!--                    <button class="btnnew noty"-->
<!--                            data-noty-options="{&quot;text&quot;:&quot;This is a success notification&quot;,&quot;layout&quot;:&quot;topRight&quot;,&quot;type&quot;:&quot;success&quot;}">-->
<!--                        Top Right-->
<!--                    </button>-->
<!--                </p>-->
<!--                <p>-->
<!--                    <button class="btnnew noty"-->
<!--                            data-noty-options="{&quot;text&quot;:&quot;This is an informaton notification&quot;,&quot;layout&quot;:&quot;topLeft&quot;,&quot;type&quot;:&quot;information&quot;}">-->
<!--                        Top Left-->
<!--                    </button>-->
<!--                </p>-->
<!--                <p>-->
        ...
        <div class="dash-unit">
            ...
            <div class="cont">
                <form action="#get-in-touch" method="POST" id="contact">
                    ...
                    <div class="textarea-container"><textarea id="message" name="message"
